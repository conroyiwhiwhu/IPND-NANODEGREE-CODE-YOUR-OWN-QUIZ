...
easy = '''
        Python is a high-level computer language. This computer language is
        used to write programs that execute instructions to perform tasks for
        us using the computer. syntax is computer grammar. Python was created
        by Guido van Rossum.
        '''
...
# game function.
input_list = [["Python", "programs", "syntax", "Guido van Rossum"],  # for easy
